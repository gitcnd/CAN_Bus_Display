...
#else
  //                 76543210
  byte p00=PORTD & 0b11010111; 
  byte p11=  p00 | 0b00101000;
  byte p10=  p00 | 0b00001000;
  byte p01=  p00 | 0b00100000;
  //                     ^ MOSI
  //                   ^ SCK

  if(data==0) { // cnd: this is so common, it overall increases speed by 10%+
    PORTD=p00;PORTD=p01;
    PORTD=p00;PORTD=p01;
    PORTD=p00;PORTD=p01;
    PORTD=p00;PORTD=p01;
...
if(data&0x80){PORTD = p10;PORTD = p11;} else {PORTD = p00;PORTD = p01;}
if(data&0x40){PORTD = p10;PORTD = p11;} else {PORTD = p00;PORTD = p01;}
if(data&0x20){PORTD = p10;PORTD = p11;} else {PORTD = p00;PORTD = p01;}
if(data&0x10){PORTD = p10;PORTD = p11;} else {PORTD = p00;PORTD = p01;}
if(data&0x08){PORTD = p10;PORTD = p11;} else {PORTD = p00;PORTD = p01;}
if(data&0x04){PORTD = p10;PORTD = p11;} else {PORTD = p00;PORTD = p01;}
if(data&0x02){PORTD = p10;PORTD = p11;} else {PORTD = p00;PORTD = p01;}
if(data&0x01){PORTD = p10;PORTD = p11;} else {PORTD = p00;PORTD = p01;}
